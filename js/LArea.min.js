window.LArea = function() {
	...
	return e.prototype = {
		init: function(e) {
			switch(this.params = e, this.trigger = document.querySelector(e.trigger), e.valueTo && (this.valueTo = document.querySelector(e.valueTo)), this.keys = e.keys, this.type = e.type || 1, this.type) {
				case 1:
				case 2:
					break;
				default:
		...
		getData: function(e) {
			...
			if("object" == typeof t.params.data) t.data = t.params.data, e();
				...
				a.open("get", t.params.data), a.onload = function(r) {
		...
		bindEvent: function() {
			function e(e) {
				...
				o.addEventListener("touchstart", a), c.addEventListener("touchstart", a), v.addEventListener("touchstart", a), o.addEventListener("touchmove", r), c.addEventListener("touchmove", r), v.addEventListener("touchmove", r), o.addEventListener("touchend", i), c.addEventListener("touchend", i), v.addEventListener("touchend", i)
			}
			...
			function r(e) {
				...
				t["pos_" + t.id] = t["o_d_" + t.id] + a, t.style["-webkit-transform"] = "translate3d(0," + t["pos_" + t.id] + "em,0)", t.setAttribute("top", t["pos_" + t.id] + "em"), e.targetTouches[0].screenY < 1 && i(e)
			}
			...
			function i(e) {
				...
				Math.abs(a) <= .2 ? t["spd_" + t.id] = 0 > a ? -.08 : .08 : Math.abs(a) <= .5 ? t["spd_" + t.id] = 0 > a ? -.16 : .16 : t["spd_" + t.id] = a / 2, t["pos_" + t.id] || (t["pos_" + t.id] = 0), n(t)
			}
		...
		setGearTooth: function(e) {
			...
			if(n > s && (n = s), i[t.index].setAttribute("data-len", r), r > 0) {
				...
				for(var l = "", v = 0; r > v; v++) l += "<div class='tooth'  ref='" + a[v][this.keys.id] + "'>" + a[v][this.keys.name] + "</div>";
				...
				t.setGearTooth(d)
			} else i[t.index].innerHTML = "<div class='tooth'></div>", i[t.index].setAttribute("val", 0), 1 == t.index && (i[2].innerHTML = "<div class='tooth'></div>", i[2].setAttribute("val", 0)), t.index = 0
		},
		finish: function(e) {
			var t = this,
			...
			t.trigger.value = s + (c ? "," + c : "") + (u ? "," + u : ""), t.value = [n, o, l], this.valueTo && (this.valueTo.value = d + (v ? "," + v : "") + (h ? "," + h : "")), t.close(e)
		},
		close: function(e) {
			e.preventDefault();
			var t = this,
